...
Shader "Custom/PracticeShader2"
{
    Properties
    {
        ...
        // sesisoft : seok jun hyuk 2021-01-12
    ...
    SubShader
    {
		...
		Pass
		{
			...
			#pragma vertex vert // vert 는 버텍스 셰이더
			#pragma fragment frag // frag 은 프래그먼트 셰이더
			...
			float4 CreateOutline(float4 vertPos, float Outline)
			{
				...
				// 단순 스케일링하는 경우.
				float4x4 scaleMat;
				scaleMat[0][0] = factor + Outline;
				scaleMat[0][1] = 0.0f;
				scaleMat[0][2] = 0.0f;
				scaleMat[0][3] = 0.0f;
				scaleMat[1][0] = 0.0f;
				scaleMat[1][1] = factor + Outline;
				scaleMat[1][2] = 0.0f;
				scaleMat[1][3] = 0.0f;
				scaleMat[2][0] = 0.0f;
				scaleMat[2][1] = 0.0f;
				scaleMat[2][2] = factor + Outline;
				scaleMat[2][3] = 0.0f;
				scaleMat[3][0] = 0.0f;
				scaleMat[3][1] = 0.0f;
				scaleMat[3][2] = 0.0f;
